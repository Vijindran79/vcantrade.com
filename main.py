...
import config
from core.models import MarketDataPoint, OverlaySignal, SignalAction, ConfidenceLevel
...
class AnalysisWorker(QThread):
    """
    Analyzes market data using LLM
    Runs in separate thread to keep UI responsive
    """
    analysis_complete = pyqtSignal(object)  # Emits LLMAnalysisOutput

...
class VcaniTradeApp:
    ...
    def __init__(self):
        ...
        # LION MODE: Daily Trade Counter - Anti-Overtrading Protection
    ...
    def _append_executor_position_ui(self, result, signal_data: dict):
        ...
        # LION MODE: Increment daily trade counter with date reset
        ...
        # LION MODE: Check daily trade limit
        if self.daily_trade_count >= config.MAX_DAILY_TRADES:
            ...
            # Set flag to prevent further trades today
    ...
    def _close_position(self, position: dict, reason: str):
        ...
        # LION MODE: Trigger Re-Entry Lock - Prevent immediate re-entry after closure

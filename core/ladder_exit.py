...
# ---------------------------------------------------------------------------
LADDER_TP1_R = 1.0          # first scale-out in R multiples (fixed: was 0.5)
LADDER_TP2_R = 2.0          # second scale-out (fixed: was 1.0)
LADDER_TP3_R = 3.0          # third scale-out (fixed: was 1.5)

LADDER_TP1_CLOSE_PCT = 0.50  # close 50% of remaining position (fixed: was 0.60)
LADDER_TP2_CLOSE_PCT = 0.30  # close 30% of remaining position (fixed: was 0.50)
LADDER_TP3_CLOSE_PCT = 0.60  # close 60% of what remains (fixed: was 0.80)

LADDER_TP1_STOP_OFFSET_R = 0.20  # move stop to entry + 0.2R after TP1
LADDER_TP2_STOP_OFFSET_R = 1.0   # move stop to TP1 after TP2

LADDER_TIME_STOP_BARS = 10      # bars before dead-money exit (fixed: was 5 per HAWK_MODE_UPGRADES.md)
